window.onload = function () {
    ...
    $(document).ready(function(){
        const alarm = sessionStorage.getItem('alarm');
        if(alarm != null) {
    ...
    document.getElementById("confirm-popup-btn").addEventListener("click", function () {
        ...
        document.getElementById("time1").innerText = timeArr[3];
        document.getElementById("time2").innerText = timeArr[4];
        document.getElementById("time3").innerText = timeArr[5];
        document.getElementById("time4").innerText = timeArr[6];
        document.getElementById("time5").innerText = timeArr[7];
        document.getElementById("time6").innerText = timeArr[8];
        document.getElementsByClassName("popup")[0].classList.remove("active");
